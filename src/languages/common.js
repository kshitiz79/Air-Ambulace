const common = {
  en: {
    ...
    completed: 'Completed',
    forwarded: 'Forwarded',
    collectorApproved: 'Collector Approved',
    dmeApproved: 'DME Approved',
    verificationStatus: 'Verification Status',
    step1Collector: 'Step 1: Collector Approval',
    step2DME: 'Step 2: DME Approval',
  ...
  hi: {
    ...
    completed: 'पूरा हुआ',
    forwarded: 'अग्रेषित',
    collectorApproved: 'कलेक्टर द्वारा अनुमोदित',
    dmeApproved: 'DME द्वारा अनुमोदित',
    verificationStatus: 'सत्यापन स्थिति',
    step1Collector: 'चरण 1: कलेक्टर स्वीकृति',
    step2DME: 'चरण 2: DME स्वीकृति',
