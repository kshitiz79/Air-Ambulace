...
export default function QueryToCmhoPage() {
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <textarea
                  ...
                  rows={6}
                  placeholder="Please provide detailed information about your query to the CMHO. Include specific questions, concerns, or clarifications needed regarding this enquiry..."
                  value={newQuery}
              ...
              <div className="flex items-center justify-between p-4 bg-yellow-50 rounded-lg">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Awaiting CMHO response</p>
                  </div>
                </div>
          ...
          {loading ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="mt-1 text-sm text-gray-500">
                Send your first query to the CMHO using the form above.
              </p>
            </div>
          ) : (
            <div className="space-y-4">
                ...
                return (
                  <div key={query.query_id} className="border border-gray-200 rounded-lg p-6 hover:shadow-md transition">
                    ...
                    <div className="space-y-4">
                      ...
                      {query.response_text && (
                        <div>
                          <p className="text-sm font-medium text-gray-700 mb-2">CMHO Response:</p>
