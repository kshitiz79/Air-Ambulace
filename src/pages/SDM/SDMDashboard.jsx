...
const SDMDashboard = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto bg-white p-6 rounded-lg shadow">
      <h2 className="text-xl font-semibold mb-4">SDM Dashboard</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        ...
        <div className="p-4 bg-green-100 rounded">
          <h3 className="font-medium">Forwarded Cases</h3>
          <p className="text-2xl">{cases.filter((c) => c.status === 'FORWARDED').length}</p>
        </div>
